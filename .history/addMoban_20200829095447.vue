	...
	<div class="addMoban">
		...
		<div class="yaofang">
            ...
            <div class="list">
                ...
                <div class="addMoban" @click="showList">添加</div>
            </div>
        </div>
        ...
        <div class="yaocaiList" v-show="medicinalWraphid">
            ...
            <div class='keyboard02' :style='{display:k2}'>
                    ...
                    <div class='hang'>
                        ...
                        <div data-key="hs" hover-class='active' hover-stay-time='100' @click='delkey' style='width:49px'><img src='../assets/img/hs.png' style='width:25px;height:25px;margin-top:11px;'></div>
                    </div>
                    </div>
            </div>
        </div>
...
<script>
	import {saveModel,lookModel,doctorSelAllDrug} from 'api/doctor'
            ...
            saveModel(){
                if(this.test()){
                    ...
                    saveModel(list).then((res)=>{
                        if(res.type == true){
                            this.$toast('保存成功');
                            this.$router.push({path:'/mobanList',query:{brandId:this.brandId,shapeId:this.shapeId,type:this.type}})
                        }else{
                            this.$toast(res.massage);
                        }
                    })
