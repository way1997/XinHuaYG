	...
	<div class="houzhen">
        ...
        <div class="userList">
            ...
            <div class="detail" v-for="(item,index) in list" :key="index">
                ...
                <div class="liaotian" @click="goLiaotian(item.patientId)">聊天</div>
                <div class="kaifang" @click="showkf(item.patientId,item.patientName,item.patientSex,item.age)">开方</div>
            </div>
        </div>
        <!--选择开方-->
...
<script>
	import {doctorChoosepri,findPatientByTel,findPatient} from "api/doctor"
