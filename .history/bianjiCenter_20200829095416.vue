<template>
	<div class="bianji">
		<div class="head">
            ...
            <span class="bianji" v-if="ifBianji" @click="bianji"><img src="../assets/img/bianji.png" alt="">编辑</span>
            <span class="back" v-if="!ifBianji" @click="quxiaoBj">取消编辑</span>
            <span class="bianji" v-if="!ifBianji" @click="querenXiu"><img src="../assets/img/bianji.png" alt="">确认修改</span>
        </div>
        <div class="info">
...
<script>
	import {doctorPreviewAllInformation,updatePortrait,beGoodList,doctorEditorGoodAtMedical,doctorEditorIntroduction} from "api/doctor"
	...
	export default {
		...
		methods:{
            ...
            doctorEditorGoodAtMedical(){
                let arr = [];
                    for(var i=0;i<this.list_adept.length;i++){
                        arr.push({medicineSubjectId:this.list_adept[i].medicineSubjectId});
                    }
                let list = {
                    token:this.token,
                    doctorId:this.doctorId,
