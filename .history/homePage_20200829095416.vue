	...
	<div class="center">
		<div class="wrap">
            ...
            <div class="list">
                ...
                <p @click="goQueren"><span>确认处方</span><img src="../assets/img/you.png" alt=""></p>
        ...
        <div class="xiugaimima" v-if="ifToken">
            <div class="xiugai">
                <div class="fangshi">
                    <p :class="{lineD:lineIdx==0}" @click="changeLine(0)">登录</p><p :class="{lineD:lineIdx==1}" @click="changeLine(1)">注册</p>
                </div>
...
<script>
	import {homePage,openIdMsg,delOpenId,doctorLoginNum,doctorLogin,doctorRegisteredNum,doctorUpdPassword,doctorRegister} from "api/doctor"
