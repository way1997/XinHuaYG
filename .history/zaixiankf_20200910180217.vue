            ...
            <div class='keyboard02' :style='{display:k2}'>
                <div class='left02 number'>
                    ...
                    <div class='hang'>
                        ...
                        <div data-key="hs" hover-class='active' hover-stay-time='100' @click='delkey' style='width:60px'><img src='../assets/img/hs.png' style='width:35px;height:35px;margin-top:8px;'></div>
                    </div>
                </div>
            </div>
        </div>
