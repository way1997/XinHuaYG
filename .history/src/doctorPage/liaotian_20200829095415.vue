    ...
    <div class="dibu_bot">
      ...
      <form>
        <div class="bottom" catchtouchmove="true">
          <div class="duihua">
            ...
            <div id="ksly" class="speakbuton" hover-class="speakbuton_1" v-show="speakbuton" @touchstart="mytouchstart"
              @touchend="mytouchend">按住说话</div>
          </div>
        </div>
      </form>
      ...
      <div :class="(n==0 ? 'animate1':'animate')">
        ...
        <div class="line tan">
          ...
          <div class="tan_but">
            <!-- <img :src="uploadImg"> -->
            <input ref="input" class="uploadPhoto" type="file" name="upload" accept="image/*"  limit="1"
