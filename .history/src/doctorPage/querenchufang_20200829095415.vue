...
<script>
import {doctorChoosepri,findPatientByTel,findPatient,findPhotoPrescription} from "api/doctor"
  ...
  data() {
    ...
    methods: {
        ...
        chufang_xq(prescriptionId){
            this.$router.push({path:'/paizhaoXq',query:{prescriptionId:prescriptionId}})
        },
        phoneSearch(){
           this.showModal = true;
        },
