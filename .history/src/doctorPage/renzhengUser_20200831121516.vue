...
<div>
    <van-form @submit='formSubmit'>
        ...
        <!--  性别选项弹出层 -->
        <van-popup v-model="sexShow" position="bottom" closeable close-icon-position="top-right" :style="{ height: '20%' }">
            <div class="popup sex-popup">
                <van-row type="flex" v-for="(item,index) in sext" :key="index" @click="sexSelc(item)" justify="center">
                    <van-col class="list sex-list" style="height:0.8rem;border:0">
