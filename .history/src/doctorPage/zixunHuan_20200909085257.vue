<template>
<div class="zixun">
    <div style="overflow-y:scroll;padding-top:.3rem">
        <HeadTop :title="pageName" :backBlack="true" :showBack="false"></HeadTop>
    </div>
    <div class="swiper-tab" style="overflow-y:scroll;padding-top:.3rem">
        <div class="swiper-tab-item" :class="(currentTab==0?'active':'')" @click="changeBtn(0)">
            <img data-current="0" :src="currentTab==0?require('../assets/img/chaxun.png'):require('../assets/img/chaxun1.png')">待问诊
        </div>
        <div class="swiper-tab-item" :class="currentTab==1?'active':''" @click="changeBtn(1)">
            ...
            <div class="tan_content" style=" white-space: nowrap;">
                ...
                <div v-for="(item,index) in lists" :key="index">
                    <div class="patient">
                        ...
                        <div class="tixinggouyao" v-if="item.check==true?false:true" @click="remindPurchase(item.patientId)">提醒购药</div>
    ...
    <div class="wrap" v-if="beijing" style="overflow-y:scroll;">
        <div class="hidden">
