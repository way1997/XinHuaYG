                    ...
                    <div class='xuanze' style="  display: flex" style='padding:0'>
                        ...
                        <block v-for="{{beGood}}">
                            <div class='section'>
                                ...
                                <div class=" text_wrap7 {{item.check?'active1':''}}" data-index="{{index}}" v-for="{{item.list}}" v-if="{{arrid==item.beGoodName?'item.check=true':'item.check=true'}}" data-check="{{item.check}}" data-text="{{item.beGoodName}}" id="{{item.beGoodId}}" bindtap='selectjib' data-index="{{index}}" data-find="{{item.find}}">{{item.beGoodName}}</div>
                            </div>
                        </block>
