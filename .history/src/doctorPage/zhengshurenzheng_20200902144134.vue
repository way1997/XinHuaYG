...
export default {
    ...
    methods: {
        ...
        generate() {
            var img1 = this.fileList_yszhiz01 ? this.fileList_yszhiz01 : this.imgs[0];
            var img2 = this.fileList_yszhiz02 ? this.fileList_yszhiz02 : this.imgs1[0];

            var img3 = this.picurl1;

            var picurl1text = this.fileList_ysziz01 ? this.fileList_ysziz01 : this.picurl1[0];
            var picurl2text = this.fileList_ysziz02 ? this.fileList_ysziz02 : this.picurl22[0];
            ...
            if (!img1) {
                ...
                var that = this;
                // var doctorId = this.$wx.getStorageSync('doctorId')
