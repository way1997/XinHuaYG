    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (!name) {
                ...
                console.log(token)
                this.axios('https://www.mfzhosp.com/mkkMoblie/doctorSupplyThree/saveDoctorInfo?doctorId=' + doctorId + '&token=' + token + '&doctorName=' + name + '&age=' + age2 + '&doctorPhoto=' + picurl + '&areaId=' + yljgid + '&doctorHospitalId=' + yljg + '&doctorSex=' + sexs + '&jobLevelId=' + levelId + '&doctorDepartmentId=' + departmentId + '&subjectIds=' + beGoodIds + '&remarks=' + introduction + '&idCard=' + shenfenzheng + '&certificateCoding=' + zhengjianhao).then(res => {
                    console.log(res)
                }).catch(error => {
                    console.log(error)
                })
