            ...
            <div class="popup sc-popup">
                ...
                <van-row>
                    <div class='xuanze' style="  display: flex" style='padding:0'>
                        <div class='xuanze_wrap' wx:if="{{jibinselect}}">
                            <block wx:for="{{arr}}">
                                <div class='text_wrap7 text_kuang'>{{item.medicineSubjectName}}</div>
                        ...
                        <!-- <div class='hist1'>*选择多个擅长后可拖动调整顺序</div> -->
                        <block wx:for="{{beGood}}">
                            <div class='section'>
                                <!-- -->
                                <div class='section1' data-text="{{beGoodNametext}}">{{item.name}}</div>
                                <div class=" text_wrap7 {{item.check?'active1':''}}" data-index="{{index}}" wx:for="{{item.list}}" wx:if="{{arrid==item.beGoodName?'item.check=true':'item.check=true'}}" data-check="{{item.check}}" data-text="{{item.beGoodName}}" id="{{item.beGoodId}}" bindtap='selectjib' data-index="{{index}}" data-find="{{item.find}}">{{item.beGoodName}}</div>
                            </div>
                        </block>
                        <div style='width:100%;height:72rpx;'></div>
                        <div class='generate1' bindtap='skilled'>
                            <div>保存</div>
                        </div>
                    </div>
                </van-row>
