...
<div class="page">
    ...
    <div class='shangp'>
        ...
        <div class='pf_but'>
            <div class="img" v-for="(item,index) in imgs" :key="index">
                ...
                <div class="guanbian" v-on:click.stop="deleteImg">
    ...
    <div class='shangp'>
        ...
        <div class="img" class='touxaing1' v-for="(item,index) imgs2" :key="index">
            ...
            <div class="guanbian" v-on:click.stop="deleteImg2">
                <img src='../assets/img/guanbian.png' v-on:click.stop="deleteImg2"></img>
            </div>
        </div>

        <div class='pf_but' v-if="{{duoxuanpic}}">
            <img src='../assets/img/jiahao.png' class='jiahao' bindtap='addpic'> </img>
