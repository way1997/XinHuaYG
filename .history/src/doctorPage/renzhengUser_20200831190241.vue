...
<div>
    <van-form @submit='formSubmit'>
        ...
        <section class="wrap">
            <van-cell-group>
                <!-- name -->
                <van-cell class='text_wrap' is-link>
                    <!-- 使用 title 插槽来自定义标题 -->
                    <template #title>
                        <span class="custom-title text_wrap_tit">姓名</span>
                    </template>
                    <template #default>
                        <input class="name nameio" type="text" value="$nbsp;" v-model="name" placeholder='姓名' id="">
                    </template>
                    <template #right-icon>
                        <van-icon name="arrow" class="arrow1-icon" />
                    </template>
        ...
        <section class="wrap">
            <div>
                <div class='jainjie_content'>
                    <textarea class='jj_content' v-model="jianjietext" style="resize:none;" value='jianjietext' maxlength='-1'>
            ...
            <div class="popup sex-popup">
                <van-row type="flex" v-for="(item,index) in sext" :key="index" @click="sexSelc(item)" justify="center">
                    <van-col class="list sex-list" style="height:0.6rem;border:0">
                        <span class="item sex-item" style="height:20px;display: block;" :style='{color:(item.name==sex1?"#00b0c2":"#222")}'>
                            {{item.name}}
                        </span>
    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (!name) {
                ...
                // this.axios(home.home + '/mkkMoblie/doctorSupplyThree/saveDoctorInfo', {
                //     params: {
                //         data: {
                //             doctorId: doctorId,
                //             token: token,
