...
<div class="page">
    ...
    <div class='enter' v-if="sctouxiang">
        ...
        <van-uploader style="display:block;">
            <van-button class='sele_pic' block style="font-size:0.3125rem;width:250px;text-align:center;height:50%">相册</van-button>
        </van-uploader>
