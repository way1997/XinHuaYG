...
export default {
    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            var shenfenzheng = e.detail.value.shenfenzheng; //省份证
            var zhengjianhao = e.detail.value.zhengjianhao; //证件号
            var yljgid = that.data.yljgid; //地区id
            var yljg = that.data.yiyuanid; //医疗机构id
            var sex1 = that.data.sex1; //性别
            var age2 = e.detail.value.age;
            console.log(age2 + "/////////////////////////////////////////");
            var departmentId = that.data.departmentId; //科室id
            var levelId = that.data.levelId; //职称id
            var beGoodIds = that.data.objss; //擅长
            var introduction = e.detail.value.introduction; //简介
            var picurl = that.data.picurl; //头像
