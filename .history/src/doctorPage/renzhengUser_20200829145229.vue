        ...
        <van-popup v-model="ksShow" position="bottom" closeable close-icon-position="top-right" :style="{ height: '80%' }">
            <div class="popup ks-popup">
                ...
                <van-row>
                    ...
                    <div wx:for="{{shanchangt}}" class='zhuanghuanyixia'>
                        <div class='text_wrap7' bindtap='shanchang_color' id="{{item.departmentId}}" style='{{item.departmentName==keshitext?"color:#fff;border:none;background:#00b0c2":"color:#222"}}' data-text="{{item.departmentName}}">{{item.departmentName}}</div>
                    </div>
