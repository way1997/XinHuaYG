            ...
            <div class="popup ks-popup">
                ...
                <van-row class="xuanzekeshi">
                    <div v-for="(item,index) in shanchangt" :key="index" class='zhuanghuanyixia'>
                        <div class='text_wrap7' @click='shanchang_color' :style="{'background':item.departmentName==keshitext? '#00b0c2' : '','color':item.departmentName==keshitext? '#fff' : '#222','border':item.departmentName==keshitext? 'none' : ''}">{{item.departmentName}}</div>
                    </div>
