            ...
            <div class="popup ks-popup">
                ...
                <van-row class="xuanzekeshi">
                    <div v-for="(item,index) in shanchangt" :key="index" class='zhuanghuanyixia'>
                        <div class='text_wrap7' @click='shanchang_color(item)' :style="{'background':item.departmentName==keshitext? '#00b0c2' : '','color':item.departmentName==keshitext? '#fff' : '#222','border':item.departmentName==keshitext? 'none' : ''}">{{item.departmentName}}</div>
                    </div>

                </van-row>
                <van-row>
                    <view class='hist'>
                        <view class='list_text'> *如果没有符合的项目,请联系私人助理或拨打客服电话
                            <view> 4001881081 </view>
                        </view>
                        <view class='generate' bindtap='keshisave'>
                            <view>保存</view>
                        </view>
                    </view>
                </van-row>
