    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (!name) {
                ...
                this.axios({
                    method: 'post',
                    url: 'https://www.mfzhosp.com/mkkMoblie/doctorSupplyThree/saveDoctorInfo?doctorId=' + doctorId + '&token=' + token + '&doctorName=' + name + '&age' + age2 + '&doctorPhoto' + picurl + '&areaId' + yljgid + '&doctorHospitalId=' + yljg + '&doctorSex' + sexs,
                    data: {
                        doctorId: doctorId,
                        token: token,
                        doctorName: name,
