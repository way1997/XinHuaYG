...
<div class="center">
    <div class="wrap">
        <div class="head">
            ...
            <p>{{doctorName}}</p>
            <div class="renzheng" @touchstart='go'>已认证</div>
        </div>
        <div class="tabBtn">
        ...
        <div class="list">
            <p @touchstart="goJifen"><span>我的积分</span><img src="../assets/img/you.png" alt=""></p>
            <p @touchstart="goMoban"><span>药方模板</span><img src="../assets/img/you.png" alt=""></p>
            <p @touchstart="goQueren"><span>确认处方</span><img src="../assets/img/you.png" alt=""><em v-if="chufangNum!=0">{{chufangNum}}</em></p>
            <p @touchstart="goBukejian"><span>不可见患者</span><img src="../assets/img/you.png" alt=""></p>
            <p @touchstart="xiugaiPsd"><span>修改密码</span><img src="../assets/img/you.png" alt=""></p>
            <!-- <p @touchstart="chongzhiZh"><span>重置账户</span><img src="../assets/img/you.png" alt=""></p> -->
            <p @touchstart="lianxiKf"><span>联系客服</span><img src="../assets/img/you.png" alt=""></p>
            <p @touchstart="tuichuDl"><span>退出登录</span><img src="../assets/img/you.png" alt=""></p>
        </div>
    </div>
    <!--热线电话-->
