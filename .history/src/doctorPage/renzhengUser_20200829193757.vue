            ...
            <div class="popup sc-popup">
                ...
                <van-row>
                    <div v-for="(item,index) in beGood" :key="index">
                        ...
                        <div class=" text_wrap7" :class="item.check?'active1':''" v-if="arrid==item.beGoodName?item.check=false:item.check=false" @click="selectjib(intem,index)" v-for="(intem,index) in item.list" :key="index">{{intem.beGoodName}}</div>
                    </div>
                </van-row>
                <van-row>
