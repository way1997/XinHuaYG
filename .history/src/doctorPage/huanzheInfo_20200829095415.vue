        ...
        <div class="qitaxinxi">
         ...
         <div class="bjxinxi" v-if="beizhu">
             <div>
                ...
                <div @click="quxiaoBei">取消</div><div @click="submit">确认</div>
             </div>
         </div>
...
<script>
	import {patientArchives,pullBlack,doctorDelPatientPlan,updateRemarks} from "api/doctor"
	...
	export default {
		...
		methods:{
            goLiaotian(){
                this.$router.push({path:'/liaotian',query:{patientId:this.patientId}})
            },
            backHome(){
            ...
            goDetail(){
                ...
                this.$router.push({path:"/zaixiankf",query:{user:JSON.stringify(user),patientId:this.patientId}});
            },
            confirm(){
                if(this.way == 0){
                    let list = {
            ...
            lookfangan(prescriptionId){
                ...
                this.$router.push({path:'/yaofangDetail',query:{prescriptionId:this.prescriptionId,patientId:this.patientId,user:JSON.stringify(user)}})
            },
		},
		components :{
			 confirm
