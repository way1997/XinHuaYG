    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (!name) {
                ...
                this.axios({
                    method: 'post',
                    url: 'https://www.mfzhosp.com/mkkMoblie/doctorSupplyThree/saveDoctorInfo?doctorId=' + doctorId + '&token=15555208228%3A1598525442989%3A0827d442844a81725179492533ad89ba',
                    data: {
                        doctorId: doctorId,
                        token: token,
                        doctorName: name,
