...
<div class="zaixiankf">
    ...
    <div class="second" v-show="step1==1">
        ...
        <div class="yaofang">
            <span>药方:</span>
            <div class="list">
                <p v-for="(item,index) in arr" :key="index"><label>{{item.medicineName}}</label><input type="number" readonly v-model='item.howWeight' @input="lengthNum(index)" @click="hideYaocai(index)"><em>g</em>
                ...
                <div class="addMoban" @click="showMedi">添加</div>
