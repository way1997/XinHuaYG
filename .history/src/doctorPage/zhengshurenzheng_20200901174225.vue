...
<div class="page">
    ...
    <div class='shangp'>
        ...
        <div class='pf_but'>
            <div class="img" v-for="(item,index) in imgs" :key="index">
                ...
                <div class="guanbian" v-on:click.stop="deleteImg(item)">
                    <img src='../assets/img/guanbian.png' v-on:click.stop="deleteImg(item)"></img>
                </div>
            </div>
    ...
    <div class='shangp'>
        ...
        <div class='pf_but'>
            <div class="img" v-for="(item,index) in picurl1" :key="index">
                ...
                <div class="guanbian" v-on:click.stop='deleteImgpicurl1(item)'>
                    <img src='../assets/img/guanbian.png' v-on:click.stop='deleteImgpicurl1(item)'></img>
                </div>
            </div>
    ...
    <div class='enter' v-if="sctouxiang">
        ...
        <div class='sele_pic' @touchstart='chooseImg'>相册</div>
