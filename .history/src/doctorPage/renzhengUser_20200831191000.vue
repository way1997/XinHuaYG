    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (!name) {
                ...
                this.axios({
                    method: 'post',
                    url: 'https://www.mfzhosp.com/mkkMoblie/doctorSupplyThree/saveDoctorInfo?doctorId=' + doctorId + '&token=' + token + '&doctorName=' + doctorName + '&age' + age + '&doctorPhoto' + picurl + '&areaId' + yljgid + '&doctorHospitalId=' + yljg,
                    data: {
                        doctorId: doctorId,
                        token: token,
                        doctorName: name,
