...
<div class="page">
    ...
    <div class='shangp'>
        ...
        <div class='pf_but'>
            ...
            <img class="touxaing" :src="fileList_ys01?fileList_ys01:''" v-if="fileList_ys01"> </img>
    ...
    <div class='enter' v-if="sctouxiang">
        ...
        <van-uploader :after-read='afterRead' style="display:block;">
            <van-button class='sele_pic' block style="font-size:0.3125rem;width:100%;height:200%;text-align:center;">相册</van-button>
            <van-button class='sele_pic' block style="font-size:0.3125rem;width:100%;height:200%;text-align:center;">拍照</van-button>
        </van-uploader>
    </div>
...
export default {
    ...
    methods: {
        ...
        afterRead(file) {
            ...
            this.fileList_ys01 = file.content
            console.log(this.fileList_ys01)
