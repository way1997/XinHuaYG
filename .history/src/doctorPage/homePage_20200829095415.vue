...
<script>
	import {homePage,openIdMsg,delOpenId,doctorLoginNum,doctorLogin,doctorRegisteredNum,doctorUpdPassword,doctorRegister,findPhotoPrescription,saveMsg} from "api/doctor"
