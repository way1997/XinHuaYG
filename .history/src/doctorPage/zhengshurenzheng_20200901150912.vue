    ...
    <div class='shangp'>
        ...
        <div class='pf_but'>
            <div class="img" v-for="(item,index) in picurl1" :key="index">
                ...
                <div class="guanbian" v-on:click.stop='deleteImgpicurl1'>
                    <img src='../assets/img/guanbian.png' v-on:click.stop='deleteImgpicurl1'></img>
                </div>
            </div>
        ...
        <div class='pf_but'>
            <div class="img" v-for="(item,index) in picurl22" :key="index">
                <img :src="item" class='touxaing' />
                <div class="guanbian" v-on:click.stop='deleteImgpicurl2'>
                    <img src='../assets/img/guanbian.png' v-on:click.stop='deleteImgpicurl2'></img>
                </div>
            </div>
            <img src='../assets/img/jiahao.png' @touchstart='picbut' class='jiahao'> </img>
