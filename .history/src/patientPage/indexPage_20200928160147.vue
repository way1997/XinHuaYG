...
export default {
    ...
    created() {
        ...
        // console.log(window.addEventListener)
        window.removeEventListener('pagehide', that.unloadHander, false);
        // 添加事件
        window.addEventListener('pagehide', that.unloadHander, false);
    ...
    destroyed() {
        ...
        window.removeEventListener('popspagehidetate', this.unloadHander);
    },
    methods: {
        pushHistory() {
            var state = {
