...
<script>
	import {myCase} from "api/patient"
	...
	export default {
        ...
                    token:this.token,
            ...
            goBuy(indentId,prescriptionId,doctorId){
              this.$router.push({path:"/chufangXq",query:{prescriptionId:indentId,indentId:prescriptionId,doctorId:doctorId}});
            },
            goXq(prescriptionId,indentStates,isPayLook){
              if(indentStates != 0||isPayLook!=0){
                this.$router.push({path:"/lookYaofang",query:{prescriptionId:prescriptionId}});
              }else{
...
<style lang="less" scoped>
    ...
    .list{
        .doctor{
            ...
            div:nth-of-type(4),div:nth-of-type(3),div:nth-of-type(5){
                width:135px;
                height:56px;
                background:#00afc2;
                border-radius:13px;
