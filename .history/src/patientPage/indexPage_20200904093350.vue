...
<div class="indexPage">
    ...
    <div class="tuijian">
        ...
        <div v-for="(item,index) in tuijianYs" :key="index">
            <div @click="goDetail(item.doctorId)" style="width: 100%;height:3.125rem">
                ...
                <div class="exp_item"><span v-for="(item,index) in item.list_adept" :key="index">{{item.medicineSubjectName}}</span></div>
            </div>
        </div>
    </div>
    <!--<div class="xian" style="clear:both;"></div>
