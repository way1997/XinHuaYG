    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                ...
                <label @click="peisong(peisong1[0].id)"><img :src="content1==peisong1[0].id?require('../assets/img/danxuan.png'):require('../assets/img/danxuang1.png')" class="tu2">{{peisong1[0].name }}</label>
