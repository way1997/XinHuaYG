<template>
  <div class="chufangxq">
    ...
    <div class="four">
      ...
      <div class="info">
        <div class="chooseWay">
          <label v-for="(item,index) in peisong1" :key="index" @click="peisong(index)"><img :src="content1==index?require('../assets/img/danxuan.png'):require('../assets/img/danxuang1.png')"
              class="tu2">{{item.name}}</label>
        </div>
      ...
      <div class="info" v-if="isAgency == 0">
        <div class="chooseWay">
          <label @click="daijian(index)" v-for="(item,index) in daijian1" :key="index"><img :src="content2==index?require('../assets/img/danxuan.png'):require('../assets/img/danxuang1.png')"
              class="tu2">{{item.name}}</label>
        </div>
