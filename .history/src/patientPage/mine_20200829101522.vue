...
<div class="mine">
    ...
    <div class="list">
        <p @touchstart="gojiuzhen"><span>健康档案</span><img src="../assets/img/you.png" alt=""></p>
        <p @touchstart="gochufang"><span>处方信息</span><img src="../assets/img/you.png" alt=""></p>
        <p @touchstart="dingdan"><span>订单信息</span><img src="../assets/img/you.png" alt=""></p>
        <p @touchstart="dizhi"><span>地址管理</span><img src="../assets/img/you.png" alt=""></p>
        <p @touchstart="lxkf"><span>联系客服</span><img src="../assets/img/you.png" alt=""></p>
    </div>
    <!--热线电话-->
