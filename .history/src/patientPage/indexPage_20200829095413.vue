<template>
	<div class="indexPage">
        ...
        <div class="tuijian">
            <h1>推荐医生</h1>
            <div @click="goDetail(item.doctorId)" v-for="(item,index) in tuijianYs" :key="index">
...
//             this.findPatient()
            ...
            addLogin(){
                ...
                addLogin(list).then((res)=>{
                    ...
                    if(res.info == 1007){
                      ...
                      cookie.set('token',res.token);
                      this.$router.push({name:'wsgrxx',params: {doctorId:res.doctorId}})
                    }
                })
            },
            relation(){
        ...
                    token:this.token,
            ...
            searchYs(){
                this.$router.push({path:'/remenJb',query:{doctorTel:this.doctorTel}});
            },
        ...
                    token:this.token,
            ...
            gowenxq(id,item){
                ...
                this.$router.push({path:"/wenzhangXq",query:{id:id,item:detailItem}});
            },
			changeIdx(index){
                this.botIdx = index;
                this.findArtcleByType();
            ...
            goDetail(doctorId){
                this.$router.push({path:'/yishengXq',query:{doctorId:doctorId}})
            },
            goremen(doctorTel){
                this.$router.push({path:'/remenJb',query:{doctorTel:doctorTel}});
            }
		},
		components :{
			 tabBar
