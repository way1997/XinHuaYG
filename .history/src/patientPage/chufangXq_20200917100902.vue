    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                ...
                <label @click="peisong(peisong1[0].id)"><img :src="contentXu==re('../assets/img/danxuang1.png'):require('../assets/img/danxuan.png')" class="tu2">{{peisong1[0].name }}</label>
                <label @click="peisong(peisong1[1].id)"><img :src="require('../?require('../assets/img/danxuang1.png'):require('../assets/img/danxuan.png')" class="tu2">{{peisong1[0].name }}</label>
