    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                ...
                <label @click="peisong(peisong1[0].id)"><img :src="contentXu==0?require('../assets/img/danxuan1.png'):require('../assets/img/danxuang0.png')" class="tu2">{{peisong1[0].name }}</label>
