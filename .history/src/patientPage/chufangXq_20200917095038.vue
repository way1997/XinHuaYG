    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                ...
                <label v-for="(item,index) in peisong1" :key="index" @click="peisong(index)"><img :src="content1==index == 1?require('../assets/img/danxuan.png'):require('../assets/img/danxuang1.png')" class="tu2">{{item.name}}</label>
            </div>
