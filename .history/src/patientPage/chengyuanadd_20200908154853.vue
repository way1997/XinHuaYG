        ...
        <div class="tianjiaBox">
            ...
            <div class="jianhurenBox" v-show="jhrHidden">
                ...
                <div class="tianjiaItem">
                    ...
                    <inputclass="tianjiaInput" v-model="list2.height" type="number" name="tall" placeholder="请输入身高" @input="shenBim">
                </div>
                <div class="tianjiaItem">
                    <div class="tianjiaTit">体重(kg)</div>
                    <input lass="tianjiaInput" v-model="list2.weight" type="number" name="weight" placeholder="请输入体重" @input="tiBim">
                </div>
                <div class="tianjiaItem">
                    <div class="tianjiaTit">BMI(kg/㎡)</div>
                    <input cass="tianjiaInput" type="number" name="bmi" disabled="true" v-model="bMI" placeholder="BMI">
                </div>
                <div class="tianjiaItem">
                    <div class="tianjiaTit">腰围(cm)</div>
                    <input clss="tianjiaInput" v-model="list2.waist" name="yaowei" type="number" placeholder="请输入腰围">
                </div>
