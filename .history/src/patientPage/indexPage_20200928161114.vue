...
export default {
    ...
    created() {
        ...
        // console.log(window.addEventListener)
        // window.removeEventListener('pagehide', that.pagehideHander, false);
        // 添加事件
        //window.addEventListener('pagehide', that.pagehideHander, false);
    ...
    destroyed() {
        ...
        window.removeEventListener('pagehide', this.unloadHander);
    },
    methods: {
        pushHistory() {
            var state = {
