    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                ...
                <label @click="peisong(peisong1[0].id)"><img :src="contentXu==peisong1[1].id?require('../assets/img/danxuan.png'):require('../assets/img/danxuang1.png')" class="tu2">{{peisong1[1].name }}</label>
            </div>
