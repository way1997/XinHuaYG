<template>
	<div class="addBing">
        ...
        <div class="tishi">请添加过敏历史，以方便医生的诊断治疗！</div>
        ...
        <input class="ipu" v-model='inputtext' placeholder='输入过敏史(仅限7个字)' :disabled="isdisplay" type='text' maxlength='7'>
...
<script>
	import {saveAllergic,allergicList,deleteAllergic} from 'api/patient'
		...
		methods:{
            ...
            allergicList(){
                ...
                allergicList(list).then((res)=>{
                    //console.log(res);
                    this.list = res.patientAllergics;
                })
            },
            surew(){
                let list = {
