...
<script>
	import {selectByIdArchives,deleteArchives} from 'api/patient'
	...
	export default {
      ...
      goDetail(id){
        this.$router.push({path:"/chengyuanxinxi",query:{id:id,ifMyself:this.ifMyself}});
      },
      goadd(){
        this.$router.push({path:"/chengyuanadd",query:{ifMyself:this.ifMyself}});
      }
		},
		components :{
			 HeadTop,confirm
