...
<div class="chufangxq">
    ...
    <div class="four">
        ...
        <div style="padding-bottom:1.3rem" class="info" v-if="isAgency == 0">
            ...
            <p><span>代煎费:</span><label>{{price3}}</label></p>
        </div>
        <div class="xian" style="clear:both;"></div>
    </div>
    <div class="total">
...
export default {
    ...
    methods: {
        ...
        patientPayPage() {
            ...
            patientPayPage(list).then((res) => {
                ...
                if (this.content2 == 0) {
                    ...
                    this.price3 = this.prices.price3
                }
                console.log(this.content2, this.price3)
        ...
        daijian(index) {
            ...
            if (this.content2 == 0) {
                this.prices.price3 = 0
            } else {
                this.prices.price3 = this.prices.price3
            }
