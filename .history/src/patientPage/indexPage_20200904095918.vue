    ...
    <div class="tuijian">
        ...
        <div v-for="(item,index) in tuijianYs" :key="index">
            <div class="doct_item" @click="goDetail(item.doctorId)" style="width: 100%;height:3.125rem">
                ...
                <div class="exp_list"><span v-for="(item,index) in item.list_adept" :key="index">{{item.medicineSubjectName}}</span></div>
            </div>
        </div>
    </div>
    <div class="xian" style="clear:both;"></div>
...
.remenJb {
    ...
    h1 {
        font-size: 0.26rem;
        padding: 0.3125rem 0 0.26rem 13px;
        color: #606060;
...
.tabList {
    .tab {
        ...
        span.borderB {
            border-bottom: 0.02re, solid #00B0C2;
            color: #00B0C2;
        }
    }
}
