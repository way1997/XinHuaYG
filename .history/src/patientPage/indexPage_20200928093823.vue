...
export default {
    ...
    created() {
        console.log('123)
                ...
                cookie.set("token", this.token) cookie.set("patientId", this.patientId)
                // this.openIdMsg();
                this.addLogin();
                ...
                console.log(window.history, window.history.pushState) if (window.history && window.history.pushState) {
