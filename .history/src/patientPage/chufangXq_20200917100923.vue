...
<div class="chufangxq" id="chufangxq">
    ...
    <div class="four">
        ...
        <div class="info" style="">
            <div class="chooseWay">
                <label v-for="(item,index) in peisong1" :key="index" @click="peisong(index)"><img :src="content1==index?require('../assets/img/danxuang1.png'):require('../assets/img/danxuan.png')" class="tu2">{{item.name}}</label>
                <label @click="peisong(peisong1[0].id)"><img :src="contentXu==peisong1[0].id?require('../assets/img/danxuang1.png'):require('../assets/img/danxuan.png')" class="tu2">{{peisong1[0].name }}</label>
                <label @click="peisong(peisong1[1].id)"><img :src="require('../assets/img/danxuang1.png')" class="tu2">{{peisong1[1].name }}</label>
            </div>
