<template>
	<div class="TabBar">
        ...
        <div class="tab-item" @click="didClickedItem(0)">
            ...
            <span :class="{active: '/houzhen' === $route.path}">候诊区</span>
        </div>
        <div class="tab-item" @click="didClickedItem(1)">
            ...
            <span :class="{active: '/huanzhe' === $route.path}">我的患者</span>
        </div>
         <div class="tab-item" @click="didClickedItem(2)">
            ...
            <span :class="{active: '/zixunHuan' === $route.path}">咨询</span>
        </div>
        <!-- <div class="tab-item">
        ...
        <div class="tab-item" @click="didClickedItem(3)">
            ...
            <span :class="{active: '/homePage' === $route.path}">个人中心</span>
        </div>
    </div>
...
<script>
    import {findPhotoPrescription,findChatPatient} from 'api/doctor'
	...
	export default {
		...
		data (){
			return {
				tabBarImgArr:[   //图片切换
                    {normal: require('../assets/img/houzhen.png'), selected: require('../assets/img/houzhen1.png')},
                    {normal: require('../assets/img/huanzhe.png'), selected: require('../assets/img/huanzhe1.png')},
                    {normal: require('../assets/img/xiaoxi.png'), selected: require('../assets/img/xiaoxi1.png')},
