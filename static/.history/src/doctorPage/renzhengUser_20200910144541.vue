...
<div>
    <van-form @submit='formSubmit'>
        <img src="../assets/img/LODING.gif" alt="" class="loading" v-if="hidden">
        <!-- 头像上传 -->
        ...
        <van-popup v-model="xcShow" position="bottom" closeable close-icon-position="top-right" :style="{ height: '16%' }">
            <van-uploader :max-count="1" :after-read='afterRead' :before-read="beforeRead" style="display:block;height:50%">
                <van-button class='sele_pic' block style="font-size:0.3125rem;width:100%;text-align:center;">相册/拍照</van-button>
                <van-button class='sele_pic' block style="font-size:0.3125rem;width:100%;text-align:center;"></van-button>
            </van-uploader>
        </van-popup>
        <!--  地区弹出层 -->
