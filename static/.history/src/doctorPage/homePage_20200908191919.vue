...
export default {
    ...
    mounted() {
        ...
        if (state) {
            this.state = state
            if (this.state == 0) {
                this.renzhengtate = '未认证'

            } else if (this.state == 3) {

                this.renzhengtate = '审核未通过 >'

            } else if (this.state == 2) {

                this.renzhengtate = '待审核 >'
    ...
    methods: {
        openIdMsg() {
            if (this.openId == '' || this.openId == null || this.openId == 'null' || this.openId == 'undefined') {
                window.location.href = 'https://www.mfzhosp.com/mkkMoblie/accessToken/openIdMsg?type=2&token=123456&id=123456&uri=https://www.mfzhosp.com/H6/@/homePage';
            ...
            homePage(list).then((res) => {
                ...
                if (res.type == true) {
                    ...
                    if (this.state == 0) {
                        ...
                        this.renzhengtate = '审核失败 >',
                            this.renzhentext = '审核未通过',
                            this.renzhenhide = true

                    } else if (this.state == 2) {

                        this.renzhengtate = '正在审核 >',
        ...
        goRenzheng() {
            ...
            } else if (this.state == 1 || this.state == 3 || this.state == 0) {
                this.$router.push({
                    name: 'renzhengUser',
                    params: {
                        token: this.token,
