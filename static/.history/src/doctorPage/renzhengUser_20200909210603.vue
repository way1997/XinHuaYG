...
<div>
    <van-form @submit='formSubmit'>
        ...
        <van-popup v-model="xcShow" position="bottom" closeable close-icon-position="top-right" :style="{ height: '16%' }">
            <van-uploader :after-read='afterRead' :before-read="beforeRead" style="display:block;height:50%">
...
export default {
    ...
    methods: {
        ...
        uploadImg(file) {
            ...
            axiosAjax.post('/mkkMoblie/uploadFile/picture', formdata1, config).then((res) => { //这里的url为后端接口
