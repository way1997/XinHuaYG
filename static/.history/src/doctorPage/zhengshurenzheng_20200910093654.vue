...
<div class="page">
    ...
    <div class='enter' v-if="sctouxiang">
        ...
        <van-uploader :before-read="beforeRead" :after-read='afterRead_yszyz01' style="display:block;">
    ...
    <div class='enter' v-if="sctouxiang1">
        ...
        <van-uploader :before-read="beforeRead" :after-read='afterRead_yszyz02' style="display:block;">
            <van-button class='sele_pic' block>相册</van-button>
            <van-button class='sele_pic' block>拍照</van-button>
        </van-uploader>
    </div>
    ...
    <div class='enter' v-if="sctouxiang2">
        ...
        <van-uploader :before-read="beforeRead" :after-read='afterRead_yszgz01' style="display:block;">
            <van-button class='sele_pic' block>相册</van-button>
            <van-button class='sele_pic' block>拍照</van-button>
        </van-uploader>
    </div>
    <div class='enter' v-if="picbut">
        ...
        <van-uploader :before-read="beforeRead" :after-read='afterRead_yszgz02' style="display:block;">
            <van-button class='sele_pic' block>相册</van-button>
            <van-button class='sele_pic' block>拍照</van-button>
        </van-uploader>
    </div>
    ...
    <div class='enter' v-if="picbut13">
        ...
        <van-uploader :before-read="beforeRead" :after-read='afterRead_zjziz01' style="display:block;">
            <van-button class='sele_pic' block>相册</van-button>
            <van-button class='sele_pic' block>拍照</van-button>
        </van-uploader>
    </div>
    ...
    methods: {
        ...
        uploadImg(file) {
            ...
            axiosAjax.post(Home.home + '/mkkMoblie/uploadFile/picture', formdata1, config).then((res) => { //这里的url为后端接口
                ...
                if (escape(this.fileDir).indexOf("%u") < 0) {
                    console.log(res);
                } else {
                    this.$toast.center("该图片" + this.fileDir + "包含中文，请修改图片名称在上传");
                }
