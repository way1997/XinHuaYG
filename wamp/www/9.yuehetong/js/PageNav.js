(function(){
	window.PageNav = PageNav;
		...
		PageNav.prototype.init = function(){
			this.$leftBtn = $("<a href='#'></a>").addClass("cBtn").html("上一页").appendTo(this.$box);
			this.$btn1 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$ellipsis1 = $("<a href='#'></a>").addClass("ellipsis").html("...").appendTo(this.$box);
			this.$btn2 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$btn3 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$btn4 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$btn5 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$btn6 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$ellipsis2 = $("<a href='#'></a>").addClass("ellipsis").html("...").appendTo(this.$box);
			
			this.$btn7 = $("<a href='#'></a>").addClass("nBtn").appendTo(this.$box);
			this.$rightBtn = $("<a href='#'></a>").addClass("cBtn").html("下一页").appendTo(this.$box);
		...
		PageNav.prototype.gotoPage = function(number){
			...
			if(this.pageAmount <= 1){
				...
				this.$leftBtn.hide();
				this.$rightBtn.hide();
				this.$box.find(".nBtn").hide();
			}else if(this.pageAmount <= 7){
				this.$ellipsis1.hide();
				this.$ellipsis2.hide();
