...
<div class="page2">
    <div class="bg-white mb-1 flex flex__v" v-for="(value,index) in list" :key="index">
        ...
        <div class="mt-1 ml-1 mr-1 mb-1" style="font-size: 0.3rem;">
            ...
            <div>
                <div class="img flex mt-1 ml-1" v-for="(val,index) in value.proclamationImage" :key="index">
                    <img :src="val.img" />
                </div>
            </div>
            <div class="flex flex__justify">
                ...
                <div class="flex">
                    <img class="icon-1" src="../assets/img/xiugai.png" @click="edit(value.proclamationId)" :data-id='value.proclamationId' />
                    <img class="icon-1" src="../assets/img/shanchu.png" @click="del(value.proclamationId)" :data-id='value.proclamationId' />
                </div>
            </div>
        </div>
    </div>
