<template>
  <div class="recordNum">
    ...
    <div class="bianzhen">
      ...
      <div class="unfold" v-if="hide" @click="showS" style="display: block">
        展开药方
      </div>
    </div>
    <!-- 原照片 -->
    ...
    <div class="extraction" v-if="show">
      ...
      <div class="yaofang2">
        ...
        <div class="tishi">
          <div
            class="tishi_yaoc"
            v-for="(item, index) in lists_pd"
            :key="index"
          >
            {{ item.medicineName }} {{ item.medicineNum }}
          </div>
        </div>
      </div>
      <div class="num">
    ...
    <div class="select_fill" v-if="show">
      <div class="select_t">
        ...
        <span >
          <a style="color:#00b0c2;border-bottom:1px solid #00b0c2" href="tel:400-188-1081">400-188-1081</a>
        </span>
      </div>
    </div>
    ...
    <div class="select_fill" v-if="show">
      ...
      <div class="select_t" style="clear: both">
        <div>【诊金】</div>
        <div
          v-for="(item, index) in lists_indent"
          :key="index"
          v-show="item.moneyDescribe == 5"
      ...
      <div class="select_t">
        <div>【服药禁忌】</div>
        <span v-for="(item, index) in taboo" :key="index">{{
          item.tabooName
        }}</span>
      </div>
      <div class="select_t">
      ...
      <div class="detail_T">
        <div v-for="(item, index) in lists_indent" :key="index">
          <div class="detail_wrap" v-if="item.moneyDescribe == 1">
            ...
            <div class="num_s">¥ {{ item.money }}</div>
          </div>
    ...
    <section style="clear: both"></section>
    <div v-if="show" style="overflow: hidden; margin: 0.4rem 0 0.8rem 0">
...
<script>
import { findPhotoPrescriptionDetails, updateSendStatus } from "api/doctor";
...
.checkbox {
  ...
  width: 0.29rem;
  height: 0.29rem;
  margin: 0.19rem 0.2rem 0 0.2rem;
}
