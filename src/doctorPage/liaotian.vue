    ...
    created() {
        this.$nextTick(function () {
            ...
            if (this.$route.query.doctorImgUrl) {
                cookie.set('doctorImgUrl', this.$route.query.doctorImgUrl)
            }
            if (this.$route.query.doctorName) {
                cookie.set('doctorName', this.$route.query.doctorName)
            }
    ...
    methods: {
        socketOpen() {
            if ("WebSocket" in window) {
                var ws = new WebSocket('wss://www.mfzhosp.com/wss?aa=' + this.doctorId, );
                socket = ws;
                ws.onopen = function () {
                    console.log('连接成功');
                };
                ...
                addChatContent(list).then((res) => {
                    ...
                    if (res.massage == 'ok') {
                        ...
                        let listArr = {
                            ...
                            d6: "请您点击详情进入查看。",
                            type: '3',
                            path: 'pages/ysxx/ysxx1?id=' + this.doctorId + '&tab=' + 1 + '&doctorImg=' + this.doctorImgUrl +
                                '&doctorName=' + this.doctorName,
                            appid: 'wx2061bee8caa00a0d',
                            url: 'https://www.mfzhosp.com/H5/#/wenzhenZx?doctorId=' + this.doctorId + '&tab=' + 1 +
                                '&doctorImg=' + this.doctorImgUrl + '&doctorName=' + this.doctorName,
                        }
                            ...
                            addChatContent(list).then((res) => {
                                ...
                                if (res.massage == 'ok') {
                                    ...
                                    let listArr = {
                                        ...
                                        d6: "请您点击详情进入查看。",
                                        type: '3',
                                        path: 'pages/ysxx/ysxx1?id=' + this.doctorId + '&tab=' + 1 + '&doctorImg=' +
                                            this.doctorImgUrl + '&doctorName=' + this.doctorName,
                                        appid: 'wx2061bee8caa00a0d',
                                    }
                                    sendMsg6(listArr).then((res) => {
