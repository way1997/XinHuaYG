    ...
    <div class="second" v-show="step1==1">
        ...
        <div class="yaofang">
            ...
            <div class="list">
                ...
                <div class="jiliang2">
                    </br>共<input type="number" v-model="preNum" :placeholder="preNum1" @focus="qingchu1" @blur="huifu1" @input="shuru1">剂,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;每日<input type="number" :placeholder="preOnce1" v-model="preOnce" @focus="qingchu2" @blur="huifu2" @input="shuru2">剂,</br></br>1剂分<input type="number" :placeholder="dayNum1" v-model="dayNum" @focus="qingchu3" @blur="huifu3" @input="shuru3">次服用
                </div>
            </div>
        </div>
    ...
    <div class="third" v-show="step1==2">
        ...
        <div class="fenlei">
            <div class="qianF" style="height:100px;">
                ...
                <p><span @click="showJin">点击选择</span><label v-show="chooseZhen"><em v-for="(item,index) in kekzhenjinana" :key="index" @click="choosePrice(item.price)">{{item.price}}</em></label></p>
            </div>
            <div class="qianF">
                <label>购药前查看药方:</label>
