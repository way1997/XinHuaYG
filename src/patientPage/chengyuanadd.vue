        ...
        <div class="tianjiaBox">
            ...
            <div class="tianjiaItem" style="border-top:1px solid #dbdbdb;">
                ...
                <div class="guanxiRightBox">
                    <div class="tianjiaInput" @touchstart="showGuanxi">
                        {{guanxi}}
                    </div>
            ...
            <div class="tianjiaItem">
                ...
                <div class='choosesex'>
                    <div :class="(sexN==index+1 ? 'check':'')" v-for="(item,index) in sexs" :key="index" @touchstart="sexChoose(index)">
                        {{item.sex}}
                    </div>
                </div>
            </div>
            ...
            <div class="tianjiaItem">
                ...
                <div class="tianjiaInput" @touchstart="showDate">
                    {{date}}
                </div>
            </div>
            ...
            <div class="jianhurenBox" v-show="jhrHidden">
                ...
                <div class="xinxiBox" style="border-top:1px solid #dbdbdb;" v-show="tiaozhuanType0001 == 0?true:false" @touchstart="goGai(1)">
                    <div class="xinxiTittle">慢性病</div>
                    <img src="../assets/img/you.png" class="youjiantou">
                </div>

                <div class="xinxiBox" v-show="tiaozhuanType0001 == 0?true:false" @touchstart="goGai(2)">
                    <div class="xinxiTittle">既往病史</div>
                    <img src="../assets/img/you.png" class="youjiantou">
                </div>

                <div class="xinxiBox" v-show="tiaozhuanType0001 == 0?true:false" @touchstart="goGai(3)">
                    <div class="xinxiTittle">家族病史</div>
                    <img src="../assets/img/you.png" class="youjiantou">
                </div>

                <div class="xinxiBox" v-show="tiaozhuanType0001 == 0?true:false" @touchstart="goGai(4)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="xiyanshi">
                        <div v-for="(item,index) in xiyanshi" :key="index" @touchstart="xiyan(item.value)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="yinjiushi">
                        <div v-for="(item,index) in yinjiushi" :key="index" @touchstart="yinjiu(item.value)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="gangongneng">
                        <div v-for="(item,index) in gangongneng" :key="index" @touchstart="gangongn(item.value)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="shengongneng">
                        <div v-for="(item,index) in shengongneng" :key="index" @touchstart="shengongn(item.value)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="hunyinzhuangkuang">
                        <div v-for="(item,index) in hunyinzhuangkuang" :key="index" @touchstart="hunyin(item.value)">
                ...
                <div class="xinxiBox2">
                    ...
                    <div class="radio-group2" name="shengyuzhuangkuang">
                        <div v-for="(item,index) in shengyuzhuangkuang" :key="index" @touchstart="shengyu(item.value)">
            ...
            <div class="tianjiaBtn" :style="{backgroundColor:backcolor}" @touchstart="insertArchives">保存</div>
        </div>
    </form>
