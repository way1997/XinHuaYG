    ...
    <div class='page' ref="page">
                ...
                <div class='left_liao'>
                    ...
                    <div v-if="item.chatType==2">
                        ...
                        <div v-if="item.sponsor==1">
                            ...
                            <div class='liaotian_ck liaotian_ck1'>
                                <div class='liaotzs_wrap2' style='margin-right:20px;' v-longTap="{methods: liaoBack,arg:{item:item}}">
                    ...
                    <div v-if="item.chatType==3">
                        <!-- 医生语音 -->
                        <div v-if="item.sponsor==1" style="height: 0.4rem;" @click="play(item.chatRoute1)">
                            <img :src='imgUrl' class='head_pic head_pic1'>
                            <div class='liaotian_ck liaotian_ck1'>
                                <img class='ltjt ltjt1' src='../assets/img/ltjt.png'>
                        ...
                        <!-- 患者语音 -->
                        <div v-if="item.sponsor==0" @click="play(item.chatRoute1)" style="height: 0.4rem;">
                            <img :src='doctorImg' class='head_pic'>
                            <div class='liaotian_ck'>
                                <img class='ltjt' src='../assets/img/ltjt.png'>
                                <div class='liaotzs_wrap'>
                    ...
                    <div v-if="item.chatType==4">
                        ...
                        <div v-if="item.sponsor==0" bindtap='medicine'>
                            ...
                            <div class='liaotian_ck'>
                                <img class='ltjt' src='../assets/img/tiaolijt.png'>
                                <div class='liaotzs_wrap1' bindtap='lookwenzhen' @click="medicine(item.entityId)">
                                    <div class='liaotzs1 tiaoli_bac tiaoli' style='float:left;margin-left:-0.06rem;margin-top:-0.19rem;'>
                                        <div class='tiaoli_top'>
                    ...
                    <div v-if="item.chatType==12">
                        ...
                        <div v-if="item.sponsor==0" bindtap='gonggao'>
                            ...
                            <div class='liaotian_ck'>
                                <img class='ltjt' src='../assets/img/tiaolijt.png'>
                                <div class='liaotzs_wrap1' bindtap='lookwenzhen'>
                                    <div class='liaotzs1 tiaoli_bac tiaoli' style='
                                            float:left;
                                            margin-left:-0.6rem;
                                            margin-top:-0.19rem;
                                            transform: translateX(.65rem);' @click="goProclamation(item.entityId)">
                                        <div class='tiaoli_top'>
        ...
        <div class="foot1" :style="{bottom:he+'px'}">
            ...
            <div class='line' v-if="voic2">
                <img src="../assets/img/bof.jpg" class="las"><!--  @click='voice1'-->
                ...
                <div>
                    <div form-type='submit' class='fasong_but1' @click="addChatContent">发送文字</div>
                </div>
            </div>
            <div class='line' v-if="!voic2">
                <img src="../assets/img/jianpan.png" @click='voice2' class='bof'>
                <div class='speakbuton' oncopy="return false" hover-class='speakbuton_1' @click="mytouchstart" @touchend="mytouchend">按住说话-不要单击</div>
...
export default {
    ...
    methods: {
                    ...
                    if (res.massage == 'ok') {
                        ...
                        let listArr = {
                            ...
                            url: 'https://www.mfzhosp.com/H5/#/liaotian?doctorId=' + this.doctorId + '&tab=' + 1 +
                                '&doctorImg=' + this.doctorImgUrl + '&doctorName=' + this.doctorName + '&patientId=' + this.patientId,
                        }
                                ...
                                if (res.massage == 'ok') {
                                    ...
                                    let listArr = {
                                        ...
                                        url: 'https://www.mfzhosp.com/H5/#/liaotian?doctorId=' + this.doctorId + '&tab=' + 1 + '&doctorImg=' + this.doctorImgUrl +
                                            '&doctorName=' + this.doctorName + '&patientId=' + this.patientId,
                                    }
                                    sendMsg6(listArr).then((res) => {
        ...
        liaoBack(e, arg) { //默认750s
            let curTime = Date.parse(new Date()) //当前时间
            let chadContTime = arg.item.sendTime //目标发送时间
            // console.log('当前时间 ' + curTime)
            // console.log('目标发送时间 ' + chadContTime)
            this.tapstart(e, arg)
        },
        tapstart(e, arg) {
            ...
            this.loop = setTimeout(() => {
                ...
                let chatDetailsId = arg.item.id
                let titCont = arg.item.chartComment
                this.isBack = true
                Dialog.confirm({
                        title: '是否撤回该消息？',
                        message: titCont,
                        confirmButtonColor: '#00b0c2'
                    })
                    .then(() => {
                        // on confirm
                        // console.log("确定撤回");
                        // console.log("token==" + token)
                        // console.log('chatDetailsId==' + chatDetailsId)
                        let list = {
                            token: token,
                            chatDetailsId: chatDetailsId,
                        }
                        this.loadUp2 = true
                        this.delChatMag(list)
                    })
                    .catch(() => {
                        // on cancel
                    })
        ...
        delChatMag(list) {
            ...
            delChatMag(list).then((res) => {
                this.loadUp2 = false
                console.log(res)
                let massage = res.massage
                this.$toast.center(massage)
                if (massage == "撤回消息成功，稍后将刷新聊天界面。") {
