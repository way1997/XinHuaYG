				...
				if (options.ad) {
					...
					for (var i in options.ad) {
						...
						$('<a>', {
							...
							title: ad.title,
							style: 'color: #fff;font-size:.3rem;z-index:101'
						}).append(
							$('<img>', {
								'src': ad.img,
							...
							$('<span>',{
								'style':'position:absolute;width:100%;left:15%;top:5%;font-size: 0.24rem;color: #9a9898;'
							}).append(ad.title),
							$('<span>',{
								'style':'position:absolute;width:100%;left:10%;top:25%;font-weight: 600;font-size: 0.36rem;line-height: 0.4rem;color: rgb(214, 173 ,56)'
							}).append(ad.content)
						).appendTo(content);
